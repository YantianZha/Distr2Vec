...
try:
    from gensim.models.word2vec_inner import train_batch_sg_biasWin, train_batch_cbow 
...
class Word2Vec(utils.SaveLoad):
    ...
    def _do_train_job(self, sentences, alpha, inits):
        ...
        if self.sg:
            ...
            #tally += train_batch_sg_biaswin(self, sentences, alpha, work) 
        else:
            ...
            while True:
                ...
                for sentence_id, sentence in job:
                    ...
                    if self.sg:
                        ...
                        #score = score_sentence_sg_biaswin(self, sentence, work)
                    else:
